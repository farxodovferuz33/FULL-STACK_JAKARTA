...
<div class="container my-5">
    <h1 style="color: cadetblue">Update the student</h1>

    <form method="post">
        <div class="mb-3">
            <label for="name" class="form-label">Full name of Student</label>
            <input value="${st.getFullName()}" type="text" class="form-control" name="name" id="name"
                   placeholder="e.g Frank Adams">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input value="${st.getGroupID()}" type="number" class="form-control" name="group_id" id="group_id"
                   placeholder="e.g 1">
        </div>
